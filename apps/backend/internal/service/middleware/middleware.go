...
type HandlerResponse struct {
	Code      int    `json:"code" dc:"错误码。0 表示成功。"`
	Message   string `json:"message" dc:"展示文案"`
	Data      any    `json:"data" dc:"处理结果"`
	ErrorCode string `json:"errorCode,omitempty" dc:"稳定的机器可读业务错误码"`
}
