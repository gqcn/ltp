...
type ListItem struct {
	...
	DatacenterName      string            `json:"datacenterName" dc:"数据中心显示名称。未分配或未登记时为空。" eg:"重庆两江"`
	DatacenterShortName string            `json:"datacenterShortName" dc:"数据中心简称。未分配或未登记时为空。" eg:"两江"`
	DatacenterColor     string            `json:"datacenterColor" dc:"数据中心展示色。未分配或未登记时为空。" eg:"#3b82f6"`
