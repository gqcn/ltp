...
type UpdateReq struct {
	...
	Region      string `json:"region" v:"max-length:64#最长 64 个字符" dc:"区域文本。空字符串表示清空区域。" eg:"重庆"`
	Color       string `json:"color" v:"max-length:16#颜色值过长" dc:"角标颜色，格式 #RRGGBB" eg:"#3b82f6"`
	Description string `json:"description" v:"max-length:256#最长 256 个字符" dc:"说明" eg:"两江数据中心 · 主训练资源区"`
}
