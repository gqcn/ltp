...
type CreateReq struct {
	...
	Color       string `json:"color" v:"max-length:16" dc:"可选角标颜色，格式 #RRGGBB。省略或非法时默认为 #3b82f6。" eg:"#3b82f6"`
	Description string `json:"description" v:"max-length:512" dc:"可选说明" eg:"两江数据中心 · 主训练资源区"`
}
