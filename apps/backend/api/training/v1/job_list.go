...
type ListJobsReq struct {
	g.Meta    `path:"/training/jobs" method:"get" tags:"Training" summary:"列出训练任务" dc:"按工作集群列出训练任务。非管理员仅见所属团队任务。筛选与分页在数据库完成后再批量刷新 Volcano 相位。" permission:"training:job:query"`
