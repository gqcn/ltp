...
type CreateReq struct {
	...
	Usernames []string `json:"usernames" v:"required" dc:"要加入的 LDAP 账号列表。上限 100。已在平台中的账号会被跳过。" eg:"[\"sunlei\"]"`
	RoleCode  string   `json:"roleCode" v:"required" dc:"统一授予的角色编码。取值 algo 或 sre。" eg:"algo"`
}
